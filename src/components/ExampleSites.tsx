...
import plnMeridaOwned from "@/assets/pln-merida-owned.png";
    ...
    <section className="relative">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div>
            <div className="flex items-center justify-center gap-3 mb-8">
              ...
              <h3 className="text-3xl font-bold text-foreground" style={{ fontFamily: "'Pirata One', cursive" }}>
                Sin Dominio <span className="animate-pulse-green">(Menos Visible)</span>
              </h3>
            </div>
            <div className="grid grid-cols-1 gap-6 max-w-2xl mx-auto">
      ...
      <div className="relative w-full h-[30vh] min-h-[250px] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 container mx-auto px-6 text-center">
          <p className="text-2xl lg:text-3xl text-white font-medium drop-shadow-lg font-mono">
