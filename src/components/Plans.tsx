      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Diseñados para ajustarse a locales comerciales que no aparecen en Google Maps tanto como para los que ya aparecen en Google, pero quieren aumentar su visibilidad
          </p>
        </div>
