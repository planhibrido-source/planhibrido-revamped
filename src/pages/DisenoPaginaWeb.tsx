  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="relative hover:scale-[1.02] transition-transform duration-300">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center px-8 py-12 space-y-3">
                  ...
                  <div className="text-xl font-bold" style={{ color: '#C00000' }}>$120 Anuales / $10 Mensuales</div>
                  <p className="text-lg font-vt323 text-[#3B2F1E] italic">Con Dominio Web incluido</p>
        ...
        {/* CTA Final */}
        <section className="relative px-4 sm:px-6 lg:px-8 pt-96 lg:pt-[93.6rem] pb-0 overflow-hidden">
          ...
          <div className="relative z-10 flex justify-center mt-8 mb-0">
            <a href="https://wa.me/584140770120?text=Hola%2C%20me%20interesa%20el%20servicio%20de%20diseño%20de%20página%20web" target="_blank" rel="noopener noreferrer" className="hover:scale-105 transition-transform">
              <img src={googleDoor} alt="Contactar por WhatsApp" className="w-96 sm:w-[28rem] md:w-[32rem] object-contain" />
            </a>
          </div>
        </section>
